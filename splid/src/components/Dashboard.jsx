    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <div className=" m-5 items-center">
          <h1 className='text-5xl text-center sm:text-4xl md:text-6xl font-sans font-bold text-[rgb(255,94,0)]  '>Group Summary</h1>
        </div>
        ...
        <div className="heading m-6 md:m-10">
          <h1 className='text-5xl font-sans font-bold text-[rgb(255,94,0)]  '>Quick Actions</h1>
        </div>
        <div className="balanceSummary   flex gap-3 justify-center flex-wrap  ">

          <div className="you-owe card    bg-white border-3 rounded-xl bg-white border-[rgb(2,149,21)] shadow-md 
          ...
          <div className="you-owe card    bg-white border-3 rounded-xl bg-white border-[rgb(2,149,21)] shadow-md 
            hover:shadow-[0_0_25px_rgba(59,130,246,0.7)] 
            transition duration-300" onClick={() => navigate("/join-group")}>
            <h2 className=' text-black font-bold font-sans sans-serif  text-2xl '>👥 <br />Join Group </h2>
          </div>
